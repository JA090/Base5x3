#' Function to allow users to get co-ordinates of a point on click, and in Analysis phase, to compute 95% CI around that point.
...
#' @param phase "Design" or "Analysis".
