#  This is a minimally modified version of the graphics::legend function (File src/library/graphics/R/legend.R
#  part of the R package, https://www.R-project.org)
# It has been modified to make the boxes shown in legend entries twice the size in both directions.
# Refer line 209
         ...
         seg.len = 2)
{
	...
	if(plot) {
	    ...
	    rect2(left = xt, top=yt+ybox/2, dx = 2*xbox, dy = 2*ybox,
		  col = fill,
